"""
Django settings for projet_syndical project.
...
ROOT_URLCONF = 'projet_syndical.urls'
...
WSGI_APPLICATION = 'projet_syndical.wsgi.application'
...
# Pour le réglage de 'phonenumber_field'    
