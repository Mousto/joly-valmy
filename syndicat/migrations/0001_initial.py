# Generated by Django 4.0.6 on 2022-08-23 13:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extrait', models.TimeField(null=True)),
                ('contenu', models.TimeField()),
                ...
                ('auteur', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='infos', to=settings.AUTH_USER_MODEL)),
            ...
            managers=[
                ('infoObjects', django.db.models.manager.Manager()),
            ],
        ),
        migrations.CreateModel(
            name='Commande',
